...
class EMA(nn.Module):
    ...
    # as it contains the number of steps taken
    # however, if you wish to access the copy of your model with EMA, then it will live at ema.ema_model

    Args:
        ema_model (int): if your model has lazylinears or other types of non-deepcopyable modules,
    ...
    def update_moving_average(self, ma_model, current_model):
        ...
        for (name, current_params), (_, ma_params) in zip(list(current_model.named_parameters()),
                                                          list(ma_model.named_parameters())):
        ...
        for (name, current_buffer), (_, ma_buffer) in zip(list(current_model.named_buffers()),
                                                          list(ma_model.named_buffers())):
            if name in self.ignore_names:
                continue
